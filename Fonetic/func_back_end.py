    ...
    for i in word_list:
        if i in consonants:
            ...
            if i in special_vowels:
                if index == 0:
                    sound_quant += 2
                    index_let2 = word_list.index(i, index)
                    if word_list[index_let2 - 1] in nn_let or word_list[index_let2 - 1] in vowels:
                        sound_quant += 2
                    elif word_list[index_let2 - 1] in consonants:
                        sound_quant += 1
            else:
                sound_quant += 1
        elif i in nn_let:
            ...
            if s in voice_cons:
                if s in vo_co_double:
                    ...
                    if s == 'ш' or s == 'ж' or s == 'ц':
                        ...
                        if index_snd + 1 in special_vowels or index_snd + 1 in nn_let or index_snd + 1 == 'и':
                ...
                if s in du_co_double:
                    ...
                    if s == 'ш' or s == 'ж' or s == 'ц':
                        ...
                        if word_list[1] in special_vowels or word_list[1] == 'и':
                            snd1.append('мягкий парный, ')
                        else:
                            snd1.append("твёрдый парный, ")
                    elif index > 0:
                        index_snd = word_list.index(s, index)
                        if index_snd + 1 in special_vowels or index_snd + 1 == 'и':
                            snd1.append('мягкий парный, ')
                        else:
                            snd1.append("твёрдый парный, ")
